	  ...
	  _createClass(Context, [{
	    ...
	    value: function install() {
	      ...
	      modules.forEach(function (module) {
	        if (module.backgrounds) _this.backgrounds.apply(_this, _toConsumableArray(module.backgrounds));
	        if (module.reducers) _this.reducers(module.reducers);
	        if (module.constants) _this.constants(module.constants);
	      });
	      return this;
	    }
	    ...
	    value: function backgrounds() {
	      ...
	      for (var _len2 = arguments.length, _backgrounds = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
	        _backgrounds[_key2] = arguments[_key2];
	      }

	      if (_backgrounds.length === 0) return this;
	      if (!this._backgrounds) this._backgrounds = new Set();
	      _backgrounds.filter(function (bg) {
	        return !_this2._backgrounds.has(bg);
	      }).forEach(function (bg) {
	        return _this2._backgrounds.add(bg);
	      });
	      return this;
	    }
	    ...
	    value: function toComponent() {
	      ...
	      var Component = function (_React$Component) {
	        ...
	        function Component() {
	          ...
	          return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this3), _this3.state = initialState, _this3.dispatch = function (action) {
	            if (!action) return;

	            if ((0, _lodash2.default)(action)) {
	              _this3.dispatchState(action);
	            } else if (typeof action === 'function') {
	              _this3.dispatch(action(_this3._getReflowContext()));
	            } else if (typeof action.then === 'function') {
	              Promise.resolve(action).then(function (action) {
	                return _this3.dispatch(action);
	              });
	            }
	          }, _this3.enterParent = function (fn) {
	            fn(_this3._getReflowContext());
	          }, _this3._getReflowContext = function () {
	            if (_this3.context.__REFLOW_PARENT_CONTEXT__) {
	              return Object.assign({}, _this3.context.__REFLOW_PARENT_CONTEXT__._getReflowContext(), _this3.getChildContext());
	            }
	            return _this3.getChildContext();
	        ...
	        _createClass(Component, [{
	          ...
	          value: function getChildContext() {
	            ...
	            reducerKeys.forEach(function (k) {
	              return context[k] = _this4.state[k];
	            });
	          ...
	          value: function componentDidMount() {
	            var context = this._getReflowContext();
	            this.unsubscribes = backgrounds.map(function (background) {
