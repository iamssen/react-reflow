...
/***/ function(module, exports, __webpack_require__) {
	...
	function provide(mapState, mapHandlers) {
	    return function (WrappedComponent) {
	        var Provided = (function (_super) {
	            ...
	            Provided.prototype.render = function () {
	                return this.state.drops && this.dropState
	                    ? react_1.cloneElement(this.props.children, this.state.drops)
	                    : null;
	            };
	            ...
	            Provided.prototype.componentWillMount = function () {
	                ...
	                if (typeof mapState !== 'function')
	                    throw new Error('...');
	                this.subscription = mapState(this.permit.observe).subscribe(function (state) {
	        ...
	        Provided.displayName = "Provided(" + WrappedComponent.displayName + ")";
	        Provided.contextTypes = {
	            reflowStore: react_1.PropTypes.object,
	        };
	        // return Stateless Component
	        return function (props) {
	            return react_1.createElement(Provided, props, react_1.createElement(WrappedComponent));
	        };
	    };
	}
