	    ...
	    value: function toComponent() {
	      ...
	      var Component = function (_React$Component) {
	        ...
	        function Component() {
	          ...
	          return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this3), _this3.state = {}, _this3.dispatch = function (action) {
	            Promise.resolve(action).then(function (action) {
	              if ((0, _lodash2.default)(action)) {
	                (function () {
	                  ...
	                  if (changed) _this3.setState(Object.assign(context, constants));
	                })();
